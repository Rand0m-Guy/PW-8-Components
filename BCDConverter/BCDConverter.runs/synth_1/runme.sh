...
HD_PWD='/home/randomguy/Documents/School/TT/Vivado/BCDConverter/BCDConverter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCDConverter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCDConverter.tcl
