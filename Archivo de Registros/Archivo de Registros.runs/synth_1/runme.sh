...
HD_PWD='/home/randomguy/Desktop/Escuela/TT/Vivado/PW-8-Components/Archivo de Registros/Archivo de Registros.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ArchReg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ArchReg.tcl
