...
HD_PWD='/home/randomguy/Desktop/Escuela/TT/Vivado/PW-8-Components/MemInstruccion/MemInstruccion.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MemInstruc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MemInstruc.tcl -notrace
