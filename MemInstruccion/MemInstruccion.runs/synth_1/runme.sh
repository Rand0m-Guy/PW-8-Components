...
HD_PWD='/home/randomguy/Desktop/Escuela/TT/Vivado/PW-8-Components/MemInstruccion/MemInstruccion.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MemInstruc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MemInstruc.tcl
