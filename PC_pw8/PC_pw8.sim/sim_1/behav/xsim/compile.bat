...
REM
REM Generated by Vivado on Mon Apr 13 22:51:48 -0600 2026
...
echo "xvhdl --incr --relax -prj tb_PC_pw8_vhdl.prj"
call xvhdl  --incr --relax -prj tb_PC_pw8_vhdl.prj -log xvhdl.log
