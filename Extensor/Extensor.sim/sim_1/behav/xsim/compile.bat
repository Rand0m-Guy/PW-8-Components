...
REM
REM Generated by Vivado on Mon Apr 13 22:19:02 -0600 2026
...
echo "xvhdl --incr --relax -prj Extensor_tb_vhdl.prj"
call xvhdl  --incr --relax -prj Extensor_tb_vhdl.prj -log xvhdl.log
