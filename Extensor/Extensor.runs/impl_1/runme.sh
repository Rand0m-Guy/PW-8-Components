...
HD_PWD='/home/randomguy/Desktop/Escuela/TT/Vivado/PW-8-Components/Extensor/Extensor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Extensor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Extensor.tcl -notrace
