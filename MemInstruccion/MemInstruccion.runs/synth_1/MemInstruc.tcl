...
synth_design -top MemInstruc -part xc7a100tcsg324-2
...
write_checkpoint -force -noxdef MemInstruc.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file MemInstruc_utilization_synth.rpt -pb MemInstruc_utilization_synth.pb"  } 
