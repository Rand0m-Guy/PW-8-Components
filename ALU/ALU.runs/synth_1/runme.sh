...
HD_PWD='/home/randomguy/Documents/School/TT/Vivado/ALU/ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_pw8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_pw8.tcl
