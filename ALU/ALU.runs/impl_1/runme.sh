...
HD_PWD='/home/randomguy/Documents/School/TT/Vivado/ALU/ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_pw8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alu_pw8.tcl -notrace
